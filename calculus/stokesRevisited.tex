...
\imageFigure{../gabook-figures/parallelogram_parameterized}{Two variable parametrization of \R{n} parallelogram}{fig:parallelogram}{0.4}
...
\imageFigure{../gabook-figures/parallelopiped_parameterized}{Three variable parametrization of \R{n} parallelepiped}{fig:parallelepiped}{0.4}
