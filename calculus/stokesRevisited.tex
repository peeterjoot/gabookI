...
\mychapter{Stokes Law revisited with algebraic enumeration of boundary}
\label{chap:PJStokes2}
...
I \Br^{u_i}
&= (-1)^{k-i} \Br_{u_1} \wedge \Br_{u_2} \wedge \cdots \wyhat{\Br_{u_i}} \cdots \wedge \Br_{u_k} \\
\end{aligned}
\end{equation}
%
...
\PD{u_1}{x^{j_1}} \cdots \wyhat{\PD{u_i}{}} \cdots \PD{u_k}{x^{j_{k-1}}}
\end{equation}
%
...
&\PD{u_1}{x^{j_1}} \cdots \wyhat{\PD{u_i}{}} \cdots \PD{u_k}{x^{j_{k-1}}} \PD{u_i}{x^{m_1}} \\
&=
\frac{(-1)^{k-i}}{(k-1)!}
\PD{x^{m_1}}{F_{m_2 m_3 \cdots m_{k}}}
{\delta^{m_k}}_{j_1}
...
\PD{u_1}{x^{m_k}} \cdots \wyhat{\PD{u_i}{}} \cdots \PD{u_k}{x^{m_{2}}} \PD{u_i}{x^{m_1}} \\
&=
...
&=
\frac{-(-1)^{i + k(k-1)/2}}{(k-1)!}
\PD{x^{n_i}}{F_{n_k n_{k-1} \cdots \wyhat{n_i} \cdots n_{1}}}
\epsilon^{n_k \cdots \wyhat{n_i} \cdots n_{1}}
\PD{u_1}{x^{n_1}} \PD{u_2}{x^{n_2}} \cdots \PD{u_k}{x^{n_k}} \\
&=
\frac{-(-1)^{i + k(k-1)/2}}{(k-1)!}
\PD{x^{n_i}}{F_{n_1 n_{2} \cdots \wyhat{n_i} \cdots n_{k}}}
\epsilon^{n_1 \cdots \wyhat{n_i} \cdots n_{k}}
\PD{u_1}{x^{n_1}} \PD{u_2}{x^{n_2}} \cdots \PD{u_k}{x^{n_k}} \\
\end{aligned}
\end{equation}
%
...
\begin{equation}
\int_{\partial V} F \cdot d^{k-1}\Bx
= \sum \int du_1 \cdots \wyhat{du_i} \cdots du_k \left.{F \cdot (I \Br^{u_i})}\right\vert_{u_i(0)}^{u_i(1)} \\
\end{equation}
%
...
&=
 \int \sum (-1)^{k-i}
\left.{F \cdot
\left( d\Bx_1 \wedge \cdots \wyhat{d\Bx_i} \cdots \wedge d\Bx_k \right)
