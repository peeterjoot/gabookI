...
\begin{equation}\label{eqn:tangentAndNormalVectors:20}
x = \gamma_\mu x^\mu,
\end{equation}
the reciprocal basis \({\gamma^\mu}\) is defined implicitly by the dot product relations
\begin{equation}\label{eqn:tangentAndNormalVectors:40}
...
\begin{equation}\label{eqn:tangentAndNormalVectors:60}
\Bp = ( x, y, f(x, y) ),
\end{equation}
...
\begin{subequations}
\begin{equation}\label{eqn:tangentAndNormalVectors:80}
\Bp_1
= \left( dx, 0, \PD{x}{f} dx \right)
\propto \left( 1, 0, \PD{x}{f} \right)
\end{equation}
\begin{equation}\label{eqn:tangentAndNormalVectors:100}
\Bp_2
...
\begin{equation}\label{eqn:tangentAndNormalVectors:120}
\begin{aligned}
\Bp_1 \wedge \Bp_2 
&=
...
\begin{equation}\label{eqn:tangentAndNormalVectors:140}
\Bp_1 \wedge \Bp_2 =
\Be_1 \Be_2 \Be_3 \left(
\Be_3
- \Be_2 \PD{y}{f}
...
\begin{equation}\label{eqn:tangentAndNormalVectors:160}
\begin{aligned}
\Bn
...
\begin{equation}\label{eqn:tangentAndNormalVectors:200}
x^3 = f(x^0, x^1, x^2).
\end{equation}
...
\begin{equation}\label{eqn:tangentAndNormalVectors:340}
\begin{aligned}
...
\begin{equation}\label{eqn:tangentAndNormalVectors:460}
\grad = \gamma^\mu \partial_\mu,
\end{equation}
we have
\begin{equation}\label{eqn:tangentAndNormalVectors:480}
\begin{aligned}
\grad x^3
...
\end{equation}
so we can write
\begin{equation}\label{eqn:tangentAndNormalVectors:500}
