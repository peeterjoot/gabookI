...
\sum_{i = 1}^k (-1)^{k-i} \int \evalrange{
   ...
   \lr{ \lr{ d\Bx_1 \wedge d\Bx_2 \cdots \wedge d\Bx_{i-1} \wedge d\Bx_{i+1} \wedge \cdots \wedge d\Bx_k } \cdot F }
}{u^i = u^i(0)}{u^i(1)},
\end{dmath}
...
F d\Bx_1 \wedge d\Bx_2 \cdots d\Bx_{i-1} d\Bx_{i+1} \cdots \wedge d\Bx_k G
}
}{u^i = u^i(0)}{u^i(1)}.
\end{dmath}
