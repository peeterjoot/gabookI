...
\imageFigure{../gabook-figures/surface_area_element}{Surface area element}{fig:surface_area_element}{0.4}
...
\imageFigure{../gabook-figures/volume_element}{Differential volume element}{fig:volume_element}{0.4}
