...
\imageFigure{../../physicsplay/figures/gabook/surface_area_element}{Surface area element}{fig:surface_area_element}{0.4}
...
\imageFigure{../../physicsplay/figures/gabook/volume_element}{Differential volume element}{fig:volume_element}{0.4}
