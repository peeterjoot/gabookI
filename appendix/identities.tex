...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:2360}
\begin{aligned}
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:2480}
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:2580}
\begin{aligned}
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:2680}
\begin{aligned}
\gpgradezero
{
  \Ba \Bb \Bc T
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:2760}
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:2780}
\begin{aligned}
\Ba \cdot \lr{ \Bb \cdot T }
&=
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:3220}
\Ba^\conj = \frac{\Bb \cdot \lr{ \Ba \wedge \Bb }}{\lr{\Ba \wedge \Bb}^2},
\end{equation}
satisfying
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:3240}
\Ba^\conj \cdot \Ba = 1,
\end{equation}
and
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:3260}
\Ba^\conj \cdot \Bb = 0.
\end{equation}
}
