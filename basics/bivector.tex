...
Let
\begin{equation}\label{eqn:bivector:1323}
\begin{aligned}
...
\begin{equation}\label{eqn:bivector:1343}
\BA \BB
=
\sum_{qrst \in [1,N]}
a_{qr}
...
\begin{equation}\label{eqn:bivector:1123}
\BA = \Bm \Bn.
\end{equation}

In this case the square of a bivector
\begin{equation}\label{eqn:bivector:1143}
\begin{aligned}
\BA^2
&= \Bm \Bn \Bm \Bn \\
&= - \Bm^2 \Bn^2,
...
Here we have
\begin{equation}\label{eqn:bivector:1183}
\begin{aligned}
...
\end{equation}
so
\begin{equation}\label{eqn:bivector:1203}
\begin{aligned}
...
\begin{equation}\label{eqn:bivector:1403}
\begin{aligned}
...
\begin{equation}\label{eqn:bivector:1243}
\BA \BB = \Bm \Bn \Bs \Bt,
\end{equation}
and
\begin{equation}\label{eqn:bivector:1263}
\begin{aligned}
\BB \BA
&= \Bs \Bt \Bm \Bn \\
&= \Bm \Bs \Bt \Bn \\
...
\end{equation}
So, we have
\begin{equation}\label{eqn:bivector:1283}
\begin{aligned}
...
\begin{equation}\label{eqn:bivector:1303}
\BA = \Be_{12} + \Be_{34}.
\end{equation}
...
This means that
\begin{equation}\label{eqn:bivector:1363}
\begin{aligned}
\inv{2} \lr{ \BA \BB + \BB \BA } &=
\gpgradezero{ \BA \BB }
+
...
\end{equation}
and that
\begin{equation}\label{eqn:bivector:1383}
\begin{aligned}
