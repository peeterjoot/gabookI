...
\begin{aligned}
\inv{2} \lr{ \BA \BB + \BB \BA } &= -\Bm^2 \inv{2} \lr{ \Bn \Bp + \Bp \Bn } = - \Bm^2 \lr{ \Bn \cdot \Bp } \\
...
There is no common factor in this bivector, so it cannot be expressed as product of normal vectors, or equivalently, as a wedge product.  To understand the effects of commutation with a pair of general bivectors consider the coordinate representation of two bivectors.  Let
...
Let's consider the possible grades of the multivector \( \Be_{qrst} \).
