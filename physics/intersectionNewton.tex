...
\imageFigure{../../physicsplay/figures/gabook/newtonsIntersectionHorizontal}{Refining an approximate horizontal intersection}{fig:newtonsIntersectionHorizontal}{0.5}
...
\imageFigure{../../physicsplay/figures/gabook/newtonsIntersectionAnyOrientation}{Refining an approximation for the intersection with an arbitrarily oriented line}{fig:newtonsIntersectionAnyOrientation}{0.5}
...
\imageFigure{../../physicsplay/figures/gabook/newtonsIntersectionTwoCurves}{Refining an approximation for the intersection of two curves in a plane}{fig:newtonsIntersectionTwoCurves}{0.5}
