...
\begin{subequations}
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:300}
\gpgrade{ u v }{\Abs{r + s}} \equiv u \wedge v
\end{equation}
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:780}
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:280}
\begin{aligned}
dx \cdot \grad f
&=
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:320}
dx \cdot
\grad f
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:560}
d^2 x
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:580}
\begin{aligned}
\grad \wedge f
&=
...
\begin{equation}\label{eqn:stokesTheoremGeometricAlgebra:760}
\begin{aligned}
